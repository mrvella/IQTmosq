...
kdrData$location <- substr(kdrData$Location_Code, 0, 6)
...
kdr_gis <- sqldf("SELECT *
                 ...
                 ON kdrData.location = gis_modelo.code
                 ")
#head(kdr_gis)
...
for(i in month){
  assign(paste0("SS.", "1016.", i)
         , subset(hasGis, format.Date(newDate, "%m")==i & (hasGis$V1016I_converted=="SS")))
  assign(paste0("SR.", "1016.", i)
         , subset(hasGis, format.Date(newDate, "%m")==i & (hasGis$V1016I_converted=="SR")))
  assign(paste0("RR.", "1016.", i)
         , subset(hasGis, format.Date(newDate, "%m")==i & (hasGis$V1016I_converted=="RR")))
}
...
makemap.1016 <- function(RR, SR, SS){
  ...
  p <- p + theme(plot.title = element_text(size = 32, face = "bold", hjust = 0.5),
...
### Print and save maps
V1016I.1
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.1", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

V1016I.2
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.2", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

#V1016I.3
#ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.3", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

V1016I.4
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.4", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

V1016I.5
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.5", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

V1016I.6
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.6", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

V1016I.7
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.7", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

V1016I.8
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.8", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

V1016I.10
ggsave(filename = paste0("maps/map_", Sys.Date(), "_V1016I.10", ".png"), width = 8, height = 8, dpi = 600, units = "in", device='png')

# # Save image of the maps
# ls()
# objects = ls()
# myplots <- objects[50:57]
# class(myplots)
# l = mget(myplots)
# invisible(mapply(ggsave, file = paste0("maps/map_", names(l), ".png"), plot=l, device = "png", dpi = 600))
