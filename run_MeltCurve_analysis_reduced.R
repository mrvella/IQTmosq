### Melt Curve Analysis 
### This script runs the melt curve analysis on the reduced data of samples that have known location codes
...
# Exclude some columns of resulting table
kdrData_a <- kdrData_a[c(3:6,10:11)]
...
#########################################
# Remove unknown location codes from kdrData_all and save file
kdrData_all <- subset(kdrData_all, Location_Code!="unknown")
write.csv(kdrData_all
...
# Save mosq2014 for further analysis
write.csv(mosq2014, "~/Dropbox/GouldLab/Project_Mosquito/Database/mosq2014.csv"
          , row.names = F)
...
# 
# # Write plot to pdf
# pdf(file = paste("figures/kdrYears_reduced_", Sys.Date(), ".pdf", sep = ""), 11, 8.5)
# print(kdrYears)
# dev.off()
# 
#   
...
# 
# # Write plot to pdf
# pdf(file = paste("figures/kdrMonths_reduced_", Sys.Date(), ".pdf", sep = ""), 11, 8.5)
# print(kdrMonths)
# dev.off()
# 
# 
...
# 
# # Write plot to pdf
# pdf(file = paste("figures/kdrZones_reduced_", Sys.Date(), ".pdf", sep = ""), 11, 8.5)
# print(kdrZones)
# dev.off()
