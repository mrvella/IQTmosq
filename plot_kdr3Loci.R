...
# mc.410.yr <- read.csv("/Users/jenbaltz/Dropbox/GouldLab/Project_Mosquito/Database/mc.410.yr_reduced.csv")

# Plot with ggplot()
kdr3Loci <- ggplot(mc.1016.yr, aes(x=year, y=freqR)) +
  ...
  scale_colour_discrete(name ="SNP", labels=c("F1534C", "V1016I", "V410L")) +
  ...
  #410
  geom_point(data = mc.410.yr, color = "purple", size = 4) +
  geom_line(data = mc.410.yr[!is.na(mc.410.yr$freqR),], color = "purple", size = 2) +
  geom_errorbar(data = mc.410.yr, aes(ymin=mc.410.yr$freqR-CI_95, ymax=mc.410.yr$freqR+CI_95), width=.2, color = "purple", size = 0.7) +
  
  labs(x = "Year", y = "Frequency", title = "Frequency of Resistance Allele at Three Loci", subtitle = "Error Bars = 95% CI") +
  ...
  annotate("text", x=2002, y=(mc.410.yr$freqR[3] + 0.03), label = mc.410.yr$n[3], color = "purple", fontface = 2) +
  annotate("text", x=2003, y=(mc.410.yr$freqR[4] + 0.03), label = mc.410.yr$n[4], color = "purple", fontface = 2) +
  annotate("text", x=2004, y=(mc.410.yr$freqR[5] + 0.03), label = mc.410.yr$n[5], color = "purple", fontface = 2) +
  annotate("text", x=2005, y=(mc.410.yr$freqR[6] + 0.03), label = mc.410.yr$n[6], color = "purple", fontface = 2) +
  annotate("text", x=2006, y=(mc.410.yr$freqR[7] + 0.03), label = mc.410.yr$n[7], color = "purple", fontface = 2) +
  annotate("text", x=2007, y=(mc.410.yr$freqR[8] + 0.03), label = mc.410.yr$n[8], color = "purple", fontface = 2) +
  annotate("text", x=2008, y=(mc.410.yr$freqR[9] + 0.03), label = mc.410.yr$n[9], color = "purple", fontface = 2) +
  annotate("text", x=2009, y=(mc.410.yr$freqR[10] + 0.03), label = mc.410.yr$n[10], color = "purple", fontface = 2) +
  annotate("text", x=2010, y=(mc.410.yr$freqR[11] + 0.03), label = mc.410.yr$n[11], color = "purple", fontface = 2) +
  annotate("text", x=2011, y=(mc.410.yr$freqR[12] + 0.03), label = mc.410.yr$n[12], color = "purple", fontface = 2) +
  annotate("text", x=2012, y=(mc.410.yr$freqR[13] + 0.03), label = mc.410.yr$n[13], color = "purple", fontface = 2) +
  annotate("text", x=2013, y=(mc.410.yr$freqR[14] + 0.03), label = mc.410.yr$n[14], color = "purple", fontface = 2) +
 ...
 ggsave(filename = paste0("figures/kdr3Loci/kdr3Loci_", Sys.Date(), ".png"), width = 11, height = 8, dpi = 600, units = "in", device='png')
